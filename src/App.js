...
function App() {
  const baseUrl = "http://localhost:80/apiFrameworks/"; //Link donde esta hostaeada nuestra API de la BD
  ...
  return (
    <div style={{textAlign: 'center'}}>
      <br />
      <button className="btn btn-success" onClick={()=>abrirCerrarModalInsertar()} >Agregar Framework</button>
      ...
      <Modal isOpen={modalInsertar}>
        ...
        <ModalFooter>
          ...
          <button className="btn btn-warning" onClick={()=>abrirCerrarModalInsertar()}>Cerrar</button>
        </ModalFooter>
      </Modal>
      ...
      <Modal isOpen={modalEditar}>
        ...
        <ModalFooter>
          ...
          <button className="btn btn-warning" onClick={()=>abrirCerrarModalEditar()}>Cerrar</button>
        </ModalFooter>
      </Modal>
